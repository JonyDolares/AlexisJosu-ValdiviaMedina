...
#### Lista de enteros:
> ```enteros = [5, 4, 8] > print("\n", enteros) > print(enteros[1]) > print(type(enteros)) > print(type(enteros[1]))```
...
#### Lista de Booleanos:
> ```Booleanos = [False, True, True] > print("\n", Booleanos) > print(Booleanos[1]) > print(type(Booleanos)) > print(type(Booleanos[1]))```
